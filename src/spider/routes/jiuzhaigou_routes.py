...
class tourist_routes(object):
    def __init__(self):
        self.page = 1
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E4%B9%9D%E5%AF%A8%E6%B2%9F&startcity=1&sv=%E4%B9%9D%E5%AF%A8%E6%B2%9F'
    ...
    def next_page(self):
        ...
        if self.page == 94:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E4%B9%9D%E5%AF%A8%E6%B2%9F&startcity=1&sv=%E4%B9%9D%E5%AF%A8%E6%B2%9F'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('九寨沟.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
