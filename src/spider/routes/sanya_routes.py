...
class tourist_routes(object):
    def __init__(self):
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?p=1&st=%E4%B8%89%E4%BA%9A&startcity=1&sv=%E4%B8%89%E4%BA%9A'
    ...
    def next_page(self, data):
        ...
        next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E4%B8%89%E4%BA%9A&startcity=1&sv=%E4%B8%89%E4%BA%9A'
        self.url = next_url
    ...
    def save_data(self, data_list):
        for i in data_list:
            ...
            with open('三亚.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
