...
class tourist_routes(object):
    def __init__(self):
        self.page = 1
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E5%91%BC%E4%BC%A6%E8%B4%9D%E5%B0%94&startcity=1&sv=%E5%91%BC%E4%BC%A6%E8%B4%9D%E5%B0%94'
    ...
    def next_page(self):
        ...
        if self.page == 100:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E5%91%BC%E4%BC%A6%E8%B4%9D%E5%B0%94&startcity=1&sv=%E5%91%BC%E4%BC%A6%E8%B4%9D%E5%B0%94'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('呼伦贝尔.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
