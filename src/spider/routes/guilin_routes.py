...
class tourist_routes(object):
    def __init__(self):
        self.page = 13
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E6%A1%82%E6%9E%97&startcity=1&sv=%E6%A1%82%E6%9E%97'
    ...
    def next_page(self):
        ...
        if self.page == 91:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E6%A1%82%E6%9E%97&startcity=1&sv=%E6%A1%82%E6%9E%97'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('桂林.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
