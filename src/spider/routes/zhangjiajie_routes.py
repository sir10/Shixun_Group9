...
class tourist_routes(object):
    def __init__(self):
        self.page = 1
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E5%BC%A0%E5%AE%B6%E7%95%8C&startcity=1&sv=%E5%BC%A0%E5%AE%B6%E7%95%8C'
    ...
    def next_page(self):
        ...
        if self.page == 37:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E5%BC%A0%E5%AE%B6%E7%95%8C&startcity=1&sv=%E5%BC%A0%E5%AE%B6%E7%95%8C'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('张家界.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
