...
class tourist_routes(object):
    def __init__(self):
        self.page = 1
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E8%A5%BF%E5%AE%89&startcity=1&sv=%E8%A5%BF%E5%AE%89'
    ...
    def next_page(self):
        ...
        if self.page == 69:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E8%A5%BF%E5%AE%89&startcity=1&sv=%E8%A5%BF%E5%AE%89'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('西安.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
