...
class tourist_routes(object):
    def __init__(self):
        self.page = 1
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E9%87%8D%E5%BA%86&startcity=1&sv=%E9%87%8D%E5%BA%86'
    ...
    def next_page(self):
        ...
        if self.page == 81:
            ...
            next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E9%87%8D%E5%BA%86&startcity=1&sv=%E9%87%8D%E5%BA%86'
            self.url = next_url
    ...
    def save_data(self, data_list):
        ...
        for i in data_list:
            ...
            with open('重庆.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
