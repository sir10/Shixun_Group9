...
class tourist_routes(object):
    def __init__(self):
        self.url = 'https://vacations.ctrip.com/list/whole/sc1.html?p=1&st=%E5%8E%A6%E9%97%A8&startcity=1&sv=%E5%8E%A6%E9%97%A8'
    ...
    def get_data(self):
        ...
        # 点击统一选择“北京出发”
        if self.url == 'https://vacations.ctrip.com/list/whole/sc1.html?p=1&st=%E5%8E%A6%E9%97%A8&startcity=1&sv=%E5%8E%A6%E9%97%A8':
    ...
    def next_page(self, data):
        ...
        next_url = 'https://vacations.ctrip.com/list/whole/sc1.html?filter=dc1&p=' + str(self.page) + '&s=2&st=%E5%8E%A6%E9%97%A8&startcity=1&sv=%E5%8E%A6%E9%97%A8'
        self.url = next_url
    ...
    def save_data(self, data_list):
        for i in data_list:
            ...
            with open('厦门.json', 'a', encoding='utf8') as f:
                data = str(data) + ',\n'
                f.write(data)
                f.close()
